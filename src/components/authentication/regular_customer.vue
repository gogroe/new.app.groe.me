<template>
  <div class="howdy">
    <!--NAVIGATION//:style explanation: changes the background color of the progress bar with an if statement-->
      ...
      return {
        ...
        regEntry: {
          name:{
            ...
            type: 'text',
            placeholder: 'Name',
            question: 'Wie ist dein Firmenname',
            value: ''
          },
          username:{
            id: 1,
            ...
            question: 'Wie ist dein Username',
            value: ''
          },
          l_form:{
            id: 2,
          ...
          city:{
            ...
            question: 'Stadt und Postleitzahl',
            value: ''
          },
          street:{
            id: 5,
