<template>
  <div>
    ...
    <!--<textarea v-if="obj.type === 'textarea'" @change="send_parrent(cur_value)" :title="obj.name" :id="obj.name" :name="obj.name" :placeholder="obj.placeholder" :class="obj.input_class" v-model="cur_value"/>-->
