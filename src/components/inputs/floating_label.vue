...
<!--<template>-->
  <!--<div class="floating_label" :class="section_class" v-click-outside="active = -1">-->
    <!--<div-->
      ...
      <!--<div @click="active = i">-->
        <!--&lt;!&ndash;<inputs&ndash;&gt;-->
          <!--&lt;!&ndash;:obj="without_placeholder(key, create_inputs, true)"&ndash;&gt;-->
          <!--&lt;!&ndash;:request_data="request_create.data"&ndash;&gt;-->
          <!--&lt;!&ndash;v-model="create_inputs.inputs[key].input"/>&ndash;&gt;-->
        <!--<label-->
        <!--<input-->
